...
(function ($, undefined) {
  ...
  $.extend($.ui, {
    ...
    hasScroll: function (el, a) {
      //If overflow is hidden, the element might have extra content, but the use_r wants to hide it
...
(function ($, undefined) {
  $.widget("ui.resizable", $.ui.mouse, {
    ...
    _mouseDrag: function (event) {
      ...
      // Put this in the mouseDrag handler since the use_r can start pressing shift while resizing
      ...
      // calling the use_r callback at the end
...
(function ($, undefined) {
  $.effects.bounce = function (o) {
    return this.queue(function () {
      ...
      var distance =
        o.options.distance ||
        (ref == "top" ? el.outerHeight(true) / 3 : el.outerWidth(true) / 3);
      if (mode == "show")
...
(function ($, undefined) {
  $.effects.drop = function (o) {
    return this.queue(function () {
      ...
      var distance =
        o.options.distance ||
        (ref == "top" ? el.outerHeight(true) / 2 : el.outerWidth(true) / 2);
      if (mode == "show")
        el.css("opacity", 0).css(ref, motion == "pos" ? -distance : distance); // Shift
    ...
    _create: function () {
      ...
      this.menu = $("<ul></ul>")
        ...
        .mousedown(function (event) {
          ...
          // the use_r clicks somewhere outside of the autocomplete
            ...
            for (var dow = 0; dow < 7; dow++) {
              ...
              tbody +=
                ...
                ((printDate.getTime() == selectedDate.getTime() &&
                  ...
                  inst._keyEvent) || // use_r pressed key
...
(function ($, undefined) {
  ...
  $.widget("ui.dialog", {
    ...
    _size: function () {
      /* If the use_r has resized the dialog, the .ui-dialog and .ui-dialog-content
  ...
  $.extend($.ui.dialog.overlay, {
    ...
    resize: function () {
      /* If the dialog is draggable and the use_r drags it past the
       * right edge of the window, the document becomes wider so we
       * need to stretch the overlay. If the use_r then drags the
        ...
        $.extend({}, o.ajaxOptions, {
          ...
          error: function (xhr, s, e) {
            ...
            try {
              ...
              // called after the use_r has selected another tab.
