              ...
              $("#side-menu a").each(function () {
                ...
                this.href == t &&
                  ...
                  (t = $(this)
                    ...
                    .parent()
                    .parent()
                    .parent()).is("body") || t.addClass("menuitem-active"));
              })),
              ...
              $(".navbar-nav a").each(function () {
                ...
                this.href == e &&
                  ...
                  (t = $(this)
                    ...
                    .parent()
                    .addClass("active")
                    .prev()).hasClass("nav-link") && t.addClass("active"));
              }),
          ...
          value: function () {
            $(document).on("click", "body", function (t) {
              1 !== $(t.target).closest("#top-search").length &&
                $("#search-dropdown").removeClass("d-block"),
                0 <
                  $(t.target).closest(".right-bar-toggle, .right-bar").length ||
                  0 <
                    $(t.target).closest(".left-side-menu, .side-nav").length ||
  ...
  ThemeCustomizer = (function () {
    function t() {
      _classCallCheck(this, t),
        ...
        (this.defaultConfig = {
          leftbar: { color: "light", size: "default", position: "fixed" },
      ...
      _createClass(t, [
        {
          ...
          value: function () {
            ...
            (e.leftbar.color =
              null !== (t = this.body.getAttribute("data-leftbar-color")) &&
              void 0 !== t
                ? t
                : this.defaultConfig.leftbar.color),
              (e.leftbar.size =
                null !== (t = this.body.getAttribute("data-leftbar-size")) &&
                void 0 !== t
                  ? t
                  : this.defaultConfig.leftbar.size),
              (e.leftbar.position =
                null !==
                  (t = this.body.getAttribute("data-leftbar-position")) &&
                void 0 !== t
                  ? t
              ...
              (e.layout.size =
                null !== (t = this.body.getAttribute("data-layout-size")) &&
                void 0 !== t
                  ? t
                  : this.defaultConfig.layout.size),
              (e.layout.mode =
                null !== (t = this.body.getAttribute("data-layout-mode")) &&
                void 0 !== t
                  ? t
                  : this.defaultConfig.layout.mode),
              (e.topbar.color =
                null !== (t = this.body.getAttribute("data-topbar-color")) &&
                void 0 !== t
                  ? t
                  : this.defaultConfig.topbar.color),
              (e.sidebar.user =
                null !== (t = this.body.getAttribute("data-sidebar-user")) &&
                void 0 !== t
                  ? t
        ...
        },
        {
          ...
          value: function () {
            ...
            document
              ...
              null !== (t = document.querySelector(".button-menu-mobile")) &&
                void 0 !== t &&
